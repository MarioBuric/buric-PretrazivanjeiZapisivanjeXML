...
namespace Programming_xml
{
    ...
    public class Tester
    {
        ...
        static void Main()
        {   
            string dir = @"D:\MyDocuments\xmlDokument";
            ...
            oneCustomer.Save("D:/MyDocuments/xmlDokument/pretrazivacbr1.xml");
            if (oneCustomer != null)
            {
            ...
            oneCustomer.Save("D:/MyDocuments/xmlDokument/pretrazivacbr2.xml");
            if (oneCustomer != null)
            {
                Console.WriteLine(oneCustomer);
            }
            ...
            oneCustomer.Save("D:/MyDocuments/xmlDokument/pretrazivacbr3.xml");
            if (oneEmail != null)
            {
            ...
            oneCustomer = query.SingleOrDefault();
            oneCustomer.Save("D:/MyDocuments/xmlDokument/pretrazivacbr4.xml");
            if (oneEmail != null)
            {
                Console.WriteLine(oneCustomer);
            }
